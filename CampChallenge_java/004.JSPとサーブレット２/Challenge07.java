...
public class Challenge07 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            */
            ...
            //profile = profileFind("2");
            
            ArrayList<String> profile = profileFind("2"); 
            
            //IDが存在しない場合はエラーメッセージ表示
            if(profile.get(0) == "0") {
                out.print("該当するidのプロフィールはありません");
            } else {
    ...
    */
    ArrayList<String> profileFind(String id) {
        ...
        for(String val : new String[]{"2","佐藤","1992年8月9日","大阪府"}) { 
            profile2.add(val);
        }
